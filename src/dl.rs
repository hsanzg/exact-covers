...
///
/// More precisely, this structure embodies an implementation of Knuth's
/// Algorithm C, as presented in Section 7.2.2.1 of [_TAOCP_ **4B**][taocp4b],
/// part 2, pages 87–91.
///
...
impl<'i, I: Eq, C> Solver<'i, I, C> {
    ...
    /// referenced is a [spacer](`Record::Spacer`) rather than an instance.
